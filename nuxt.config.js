...
export default {
  ...
  */
  ...
  env: {
    ...
    welcomeTeamProjects: "Drag and Drop members from team in the project team tab and request bids, a notification will be sent to them. You can also send a group message to them, see the blue msg button on project team tab."
  },
  /*
